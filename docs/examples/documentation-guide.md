...
- Audience: `Future Codex sessions and human operators`
- Source of truth scope: `Example documentation policy for repositories created from this template`

This example shows the documentation taxonomy and update rules a new repository can adopt from this template.
...
- CI path check: `.github/workflows/docs-check.yml`
- Non-blocking markdown lint CI: `.github/workflows/markdownlint.yml`
- Markdownlint repo config: `.markdownlint.jsonc`
